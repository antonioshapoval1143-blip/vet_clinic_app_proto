...
################################################################################
## Form generated from reading UI file 'reg_empl.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox.setGeometry(QRect(220, 420, 141, 22))
    ...
    # setupUi
        self.comboBox_2.addItems(["Терапевт загальної практики", "Хірург", "Дерматолог", "Кардіолог", "Офтальмолог", "Ортопед", "Стоматолог", "Репродуктолог", "Лаборант-аналітик"])
        #self.comboBox.addItems(["Стажер", "Молодший ветеринарний лікар", "Ветеринарний лікар", "Старший ветеринарний лікар", "Головний лікар клініки"])
        self.comboBox_3.addItems(["Повна зайнятість", "Часткова зайнятість", "Позмінна робота", "Виїзди на дім", "Консультації онлайн"])
        ...
        if checking.next():
            ...
            if confirm == "apr":
                if self.radioButton.isChecked():
                    ...
                    if not doc_registr.exec(
                        f"INSERT INTO `doctors` (`doctor_id`, `last_name`, `first_name`, `middle_name`, `adress`, `location`, `specialization`, `animal_type`, `work_format`, `contact_info`, `experience`) "
                        f"VALUES (NULL, '{lstname}', '{frtname}', '{midname}', '{adress}', '{loc}', '{spec}', '{animal_type}', '{work_format}', '{phonenum}', '{exp}');"
                    ):
                    ...
                    if not adm_registr.exec(
                        f"INSERT INTO `admins` (`admin_id`, `last_name`, `first_name`, `middle_name`, `specialization`, `adress`, `location`, `phone_number`) VALUES (NULL, '{lstname}', '{frtname}', '{midname}', '{spec}', '{adress}', '{loc}', '{phonenum}');"
                    ):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_11.setText(QCoreApplication.translate("Form", u"\u0420\u0456\u0432\u0435\u043d\u044c \u043a\u0432\u0430\u043b\u0456\u0444\u0456\u043a\u0430\u0446\u0456\u0457", None))
